...
namespace ASPAssesment.Controllers
{
    public class ClaimsController : Controller
    {
        ...
        public ClaimsController(jonatanLeonDatabaseContext context)
        {
            _context = context;
        }
        ...
        {
            var jonatanLeonDatabaseContext = _context.Claims.Include(c => c.Vehicle);
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'jonatanLeonDatabaseContext.Claims'  is null.");
            }
            var claim = await _context.Claims.FindAsync(id);
            if (claim != null)
            {
